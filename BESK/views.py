...
def index(request):
    ...
    faaliyetler = Faaliyet.objects.all()
    context = {
        'projeler' : projeler,
        'faaliyetler' : faaliyetler,
    }
    return render(request, 'besk/index.html', context)
def contact(request):
...
def projedetail(request, id):
    proje = Proje.objects.get(id = id)
    context= {
        'proje' : proje
    }
    return render(request, 'besk/productdetail.html', context)
