...
class Proje(models.Model):
    ...
    team = models.ForeignKey("Team", verbose_name=("Proje Sorumlusu"), on_delete=models.CASCADE, blank=True, null=True)
    ulke = models.CharField(("Ülke"), max_length=50, blank=True, null=True)
    sehir = models.CharField(("Sehir"), max_length=50, blank=True, null=True)
    ...
    image = models.FileField(("Proje Görseli"), upload_to=None, max_length=100, blank=True, null=True)
    image1 = models.FileField(("Proje Görseli"), upload_to=None, max_length=100, blank=True, null=True)
    image2 = models.FileField(("Proje Görseli"), upload_to=None, max_length=100, blank=True, null=True)
